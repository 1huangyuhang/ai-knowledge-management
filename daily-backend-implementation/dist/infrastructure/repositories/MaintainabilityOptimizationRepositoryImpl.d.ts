...
export declare class MaintainabilityOptimizationRepositoryImpl implements MaintainabilityOptimizationRepository {
    private maintainabilityConfig;
    private codeQualityReports;
    private codeQualityIssues;
    private techDebts;
    private documentationStatuses;
    private maintainabilityMetrics;
    private maintainabilityEvents;
...
//# sourceMappingURL=MaintainabilityOptimizationRepositoryImpl.d.ts.map